### Looks like some institutions don't have great data in OpenAlex currently (like NIWA). Institutions like Te Pūkenga have a ROR which is linked to it's children institutions, but OpenAlex does not currently pool child organisation results in data from the parent organisation. I've added Te Pūkenga here in the hope this changes at some point.
...
## Panel 1: Plot open status for each institution over time
...
# Panel 2: Plot access type for each institution over time.
...
# Panel 3: Plot access type for each institution for the previous year
