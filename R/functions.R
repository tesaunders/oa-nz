plot_theme <- function(type = c("light", "dark"), base_size = 20, base_family = "sans") { 
  type <- match.arg(type)
  ...
  if (type == "light") {
    selected_theme <- theme(
      ...
      plot.caption = element_text(colour = "black", face = "italic")
    )
  } else {
    selected_theme <- theme(
      ...
      plot.caption = element_text(colour = "grey70", face = "italic")
    )
  }
