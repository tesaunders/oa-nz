...
cit_nz$oa_status <- factor(cit_nz$oa_status, levels = c("closed", "hybrid", "gold", "green", "diamond", "bronze"))

cit_au$oa_status <- factor(cit_au$oa_status, levels = c("closed", "hybrid", "gold", "green", "diamond", "bronze"))
```
