...
```{r}
cat("title=", unique(plot_nz_list[[1]]$labels$title))
plot_nz_list[[1]]
```

```{r}
cat("title=", unique(plot_nz_list[[2]]$labels$title))
plot_nz_list[[2]]
```

```{r}
cat("title=", unique(plot_nz_list[[3]]$labels$title))
plot_nz_list[[3]]
```

```{r}
cat("title=", unique(plot_nz_list[[4]]$labels$title))
plot_nz_list[[4]]
```

```{r}
cat("title=", unique(plot_nz_list[[5]]$labels$title))
plot_nz_list[[5]]
```

```{r}
cat("title=", unique(plot_nz_list[[6]]$labels$title))
plot_nz_list[[6]]
```

```{r}
cat("title=", unique(plot_nz_list[[7]]$labels$title))
plot_nz_list[[7]]
```

```{r}
cat("title=", unique(plot_nz_list[[8]]$labels$title))
plot_nz_list[[8]]
```
...
```{r}
cat("title=", unique(plot_au_list[[1]]$labels$title))
plot_au_list[[1]]
```

```{r}
cat("title=", unique(plot_au_list[[2]]$labels$title))
plot_au_list[[2]]
```

```{r}
cat("title=", unique(plot_au_list[[3]]$labels$title))
plot_au_list[[3]]
```

```{r}
cat("title=", unique(plot_au_list[[4]]$labels$title))
plot_au_list[[4]]
```

```{r}
cat("title=", unique(plot_au_list[[5]]$labels$title))
plot_au_list[[5]]
```

```{r}
cat("title=", unique(plot_au_list[[6]]$labels$title))
plot_au_list[[6]]
```

```{r}
cat("title=", unique(plot_au_list[[7]]$labels$title))
plot_au_list[[7]]
```

```{r}
cat("title=", unique(plot_au_list[[8]]$labels$title))
plot_au_list[[8]]
```
