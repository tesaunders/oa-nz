...
# Loop through URLs to retrieve JSON data from API
...
# Filter to relevant values, add institution name and oa type
...
# Export data to .csv file with year appended

write.csv(oa_status, paste0("data/oa_status_", prev_year, ".csv"), row.names = FALSE)

# Reorder factor levels and define title for plot
